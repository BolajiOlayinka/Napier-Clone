        ...
        <NavSection>
          ...
          {(!isSmallScreen || isOpen) && (
            <React.Fragment>
              ...
              <button
                onMouseEnter={() => setStudyIsShown(true)}
                onMouseLeave={() => setStudyIsShown(false)}
              >
                Study with us
              </button>
              <button
                onMouseEnter={() => setGlobalIsShown(true)}
                onMouseLeave={() => setGlobalIsShown(false)}
              >
                Study Global
              </button>
              <button
                onMouseEnter={() => setResearchIsShown(true)}
                onMouseLeave={() => setResearchIsShown(false)}
              >
                Research and Innovation
              </button>
              <button
                onMouseEnter={() => setAlumniIsShown(true)}
                onMouseLeave={() => setAlumniIsShown(false)}
              >
                Alumni
              </button>
              <button
                onMouseEnter={() => setAboutIsShown(true)}
